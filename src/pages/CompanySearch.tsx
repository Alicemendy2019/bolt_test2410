...
const CompanySearch: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h2 className="text-2xl font-semibold mb-4">会社情報から企業を検索</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="name" className="block text-sm font-medium text-gray-700">社名</label>
          <input
            type="text"
            id="name"
            name="name"
        ...
        <div>
          <label htmlFor="corporateNumber" className="block text-sm font-medium text-gray-700">法人番号</label>
          <input
            type="text"
            id="corporateNumber"
